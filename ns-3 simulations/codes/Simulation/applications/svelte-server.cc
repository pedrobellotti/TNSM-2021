...
bool
SvelteServer::GetPingTracking (void) const
{
  NS_LOG_FUNCTION (this);

  return m_pingTracking;
}
...
void
SvelteServer::SetPingTracking (std::string cookie)
{
...
void
SvelteServer::NotifyRx (uint32_t rxBytes, std::string cookie, bool track, Time timestamp)
{
