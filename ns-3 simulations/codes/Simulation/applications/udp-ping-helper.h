...
public:
  /**
   * Create UdpPingServerHelper which will make life easier for people trying
...
public:
  /**
   * Create UdpPingClientHelper which will make life easier for people trying
   ...
   */
  UdpPingClientHelper (Address ip, uint16_t port);
  /**
   * Create UdpPingClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  UdpPingClientHelper (Address addr);
