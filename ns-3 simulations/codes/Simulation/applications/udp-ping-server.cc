...
NS_LOG_COMPONENT_DEFINE ("UdpPingServerApplication");
...
UdpPingServer::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::UdpPingServer")
    ...
    .AddTraceSource ("Rx", "A packet has been received",
                     MakeTraceSourceAccessor (&UdpPingServer::m_rxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("RxWithAddresses", "A packet has been received",
                     MakeTraceSourceAccessor (&UdpPingServer::m_rxTraceWithAddresses),
...
UdpPingServer::StartApplication (void)
{
  ...
  m_socket6->SetRecvCallback (MakeCallback (&UdpPingServer::HandleRead, this));
}
