...
private:
  ...
  uint16_t m_port; //!< Port on which we send packets.
  ...
  Ptr<OutputStreamWrapper>        m_pingHW;         //!< Log de saída do ping nos switch HW.
  Ptr<OutputStreamWrapper>        m_pingSW;         //!< Log de saída do ping nos switch SW.
